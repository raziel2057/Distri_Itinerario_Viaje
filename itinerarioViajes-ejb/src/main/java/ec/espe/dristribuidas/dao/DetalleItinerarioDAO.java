...
@LocalBean
@Stateless 
public class DetalleItinerarioDAO extends DefaultGenericDAOImple<DetalleItinerario, DetalleItinerarioPK>{
    
    public DetalleItinerarioDAO() {
        super(DetalleItinerario.class);
    }
}
